...
# Utilizamos esto para la ultima consigna que nos pide determinar  si hay figuras en el mazo del jugador
...
if valorplayer1 == "A":
    ...
    if valorplayer1 == "J" or valorplayer1 == "Q" or valorplayer1 == "K":
        valorplayer1 = 10
        figuras_player = True
...
if crupiervalor1 == "A":
    ...
    if crupiervalor1 == "J" or crupiervalor1 == "Q" or crupiervalor1 == "K":
        crupiervalor1 = 10
...
print(nmb, "tu puntaje total hasta ahora es de: ", valor_total_player)
...
print("El total hasta ahora del croupier es de: ", total_croupier)

input("\nPulse enter para continuar")

valorplayer3 = 0
if valor_total_player <= 19:   # vamos a hacer que si tiene 19 se plante ya que es muy probable que se pase de 21 y pierda
...
croupiervalor3 = 0
if total_croupier <= 17:   # vamos a hacer que si tiene 17 se plante ya que es muy probable que se pase de 21 y pierda
...
if total_croupier < valor_total_player <= 21:
    ...
    if valor_total_player < total_croupier <= 21:
        ...
        if total_croupier == valor_total_player:
            ...
            if (total_croupier and valor_total_player) > 21:
                print("Es un empate, ambos han perdido")
            else:
                if total_croupier > 21 >= valor_total_player:
                    print("¡FELICIDADES", nmb, "HAS GANADO<3!")
                else:
                    if valor_total_player > 21 >= total_croupier:
                        print("El croupier ha ganado,", nmb, "has perdido :(")
...
if ambos_palos and valorplayer1 == crupiervalor1:
    print("¡WOW! No solo han coincidido en palo, sino tambien en el numero!")
